 ...
 */
export const ContractInvoiceRowSchema = z
  .object({
    article_number: z.string().optional().describe("Article number"),
    description: z.string().optional().describe("Row description"),
    price: z.number().optional().describe("Unit price excluding VAT"),
    ...
    project: z.string().optional().describe("Project number"),
    row_id: z
      .number()
      .int()
      .optional()
...
export const CreateContractSchema = z
  .object({
    customer_number: z.string().min(1).describe("Customer number (required)"),
    period_end: z
      .string()
      .regex(/^\d{4}-\d{2}-\d{2}$/)
      .describe("End date for the contract period YYYY-MM-DD (required)"),
    invoice_rows: z
      .array(ContractInvoiceRowSchema)
      .min(1)
    ...
    our_reference: z.string().max(25).optional().describe("Our reference"),
    your_reference: z.string().optional().describe("Customer reference"),
    terms_of_payment: z.string().optional().describe("Payment terms code"),
    comments: z.string().max(1024).optional().describe("Internal comments"),
    remarks: z
      .string()
      .max(1024)
      .optional()
